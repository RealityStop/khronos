    ...
    <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2193861774">
      <_items dataType="Array" type="Duality.Component[]" id="2855859408" length="8">
        ...
        <item dataType="Struct" type="Khronos.Powerups.Projectiles.Projectile" id="2156620449">
          <_x003C_Bounce_x003E_k__BackingField dataType="Bool">false</_x003C_Bounce_x003E_k__BackingField>
          <_x003C_BounceWallSound_x003E_k__BackingField dataType="Struct" type="System.Collections.Generic.List`1[[Duality.ContentRef`1[[Duality.Resources.Sound]]]]" id="1449714213">
            <_items dataType="Array" type="Duality.ContentRef`1[[Duality.Resources.Sound]][]" id="2751321238" length="4">
              <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Sound]]">
                <contentPath dataType="String">Data\Media\audio\fx\impact\boom6.Sound.res</contentPath>
              </item>
            </_items>
            <_size dataType="Int">1</_size>
          </_x003C_BounceWallSound_x003E_k__BackingField>
          <_x003C_HitGhostSound_x003E_k__BackingField />
          <_x003C_HitPlayerSound_x003E_k__BackingField dataType="Struct" type="System.Collections.Generic.List`1[[Duality.ContentRef`1[[Duality.Resources.Sound]]]]" id="1463083880">
            <_items dataType="Array" type="Duality.ContentRef`1[[Duality.Resources.Sound]][]" id="3132774095" length="4">
              <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Sound]]">
                <contentPath dataType="String">Data\Media\audio\fx\impact\boom6.Sound.res</contentPath>
              </item>
            </_items>
            <_size dataType="Int">1</_size>
          </_x003C_HitPlayerSound_x003E_k__BackingField>
          <_x003C_HitWallSound_x003E_k__BackingField dataType="Struct" type="System.Collections.Generic.List`1[[Duality.ContentRef`1[[Duality.Resources.Sound]]]]" id="1220470511">
            <_items dataType="Array" type="Duality.ContentRef`1[[Duality.Resources.Sound]][]" id="183683300" length="4">
              <item dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Sound]]">
                <contentPath dataType="String">Data\Media\audio\fx\impact\boom2.Sound.res</contentPath>
              </item>
            </_items>
            <_size dataType="Int">1</_size>
          </_x003C_HitWallSound_x003E_k__BackingField>
        ...
        <item dataType="Struct" type="Khronos.Powerups.Projectiles.ProjectileWorldCollider" id="3572604507">
          <active dataType="Bool">true</active>
          <gameobj dataType="ObjectRef">1631800621</gameobj>
          <previousPosition dataType="Struct" type="Duality.Vector3">
            <X dataType="Float">361</X>
            <Y dataType="Float">-429</Y>
            <Z dataType="Float">0</Z>
          </previousPosition>
