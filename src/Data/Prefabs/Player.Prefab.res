<root dataType="Struct" type="Duality.Resources.Prefab" id="129723834">
  ...
  <objTree dataType="Struct" type="Duality.GameObject" id="2105844559">
    <active dataType="Bool">true</active>
    <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="2241309172">
      <_items dataType="Array" type="Duality.GameObject[]" id="2799420580" length="4">
        <item dataType="Struct" type="Duality.GameObject" id="29283026">
          <active dataType="Bool">true</active>
          <children />
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2085651202">
            <_items dataType="Array" type="Duality.Component[]" id="901000592" length="4">
              <item dataType="Struct" type="Duality.Components.Transform" id="86560244">
                <active dataType="Bool">true</active>
                ...
                <gameobj dataType="ObjectRef">29283026</gameobj>
                <ignoreParent dataType="Bool">false</ignoreParent>
                <parentTransform dataType="Struct" type="Duality.Components.Transform" id="2163121777">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <angleVel dataType="Float">0</angleVel>
              ...
              <item dataType="Struct" type="Duality.Components.Renderers.TextRenderer" id="912220680">
                <active dataType="Bool">true</active>
                ...
                <text dataType="Struct" type="Duality.Drawing.FormattedText" id="3774391672">
                  <flowAreas />
                  <fonts dataType="Array" type="Duality.ContentRef`1[[Duality.Resources.Font]][]" id="1650364268">
          ...
          <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="4098538378" surrogate="true">
            <header />
            <body>
              <keys dataType="Array" type="System.Object[]" id="3922967256">
                <item dataType="Type" id="3048984492" value="Duality.Components.Transform" />
                <item dataType="Type" id="2589338550" value="Duality.Components.Renderers.TextRenderer" />
              </keys>
              <values dataType="Array" type="System.Object[]" id="319488158">
                <item dataType="ObjectRef">86560244</item>
                <item dataType="ObjectRef">912220680</item>
              </values>
            </body>
          </compMap>
          <compTransform dataType="ObjectRef">86560244</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="1886358148">E8S99zwvaUq5HVRPgV/nAQ==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          <name dataType="String">Title</name>
          <parent dataType="ObjectRef">2105844559</parent>
          <prefabLink />
        </item>
      </_items>
    ...
    <compTransform dataType="ObjectRef">2163121777</compTransform>
    <identifier dataType="Struct" type="System.Guid" surrogate="true">
      <header>
        <data dataType="Array" type="System.Byte[]" id="2250399860">o3s69e71SU2ZWUCGNfDoDA==</data>
      </header>
      <body />
    </identifier>
    <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
