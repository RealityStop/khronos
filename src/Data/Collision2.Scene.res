  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    <item dataType="Struct" type="Duality.GameObject" id="1016267709">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="113641103">
        <_items dataType="Array" type="Duality.GameObject[]" id="934333614">
            ...
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3711240046">
              <_items dataType="Array" type="Duality.Component[]" id="3317601360" length="4">
                ...
                <item dataType="Struct" type="Khronos.World.Level.PlayerSpawnPoint" id="1945396596">
                  ...
                  <_x003C_OffsetY_x003E_k__BackingField dataType="Int">7</_x003C_OffsetY_x003E_k__BackingField>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="3205583843">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3677858897">
        <_items dataType="Array" type="Duality.Component[]" id="3751200750" length="4">
          <item dataType="Struct" type="Khronos.ConstantsEditorComponent" id="2072178598">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">3205583843</gameobj>
          </item>
        </_items>
        <_size dataType="Int">1</_size>
      </compList>
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2413111456" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="1879422843">
            <item dataType="Type" id="2158747478" value="Khronos.ConstantsEditorComponent" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="1919974568">
            <item dataType="ObjectRef">2072178598</item>
          </values>
        </body>
      </compMap>
      <compTransform />
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="3529653873">2B46fWfNxkanOdPVVuJXxw==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <parent />
      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="2577247939">
        <changes />
        <obj dataType="ObjectRef">3205583843</obj>
        <prefab dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
          <contentPath dataType="String">Data\Prefabs\Templates\Constants.Prefab.res</contentPath>
        </prefab>
      </prefabLink>
    </item>
    <item dataType="Struct" type="Duality.GameObject" id="776100436">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3209407082">
        <_items dataType="Array" type="Duality.Component[]" id="508773408" length="4">
          <item dataType="Struct" type="Duality.Components.Transform" id="833377654">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">776100436</gameobj>
          </item>
          <item dataType="Struct" type="Duality.Components.Camera" id="2322486913">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">776100436</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2579092186" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="3456477264">
            <item dataType="ObjectRef">1948057750</item>
            <item dataType="Type" id="1644280252" value="Duality.Components.Camera" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="3779725678">
            <item dataType="ObjectRef">833377654</item>
            <item dataType="ObjectRef">2322486913</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">833377654</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="1784784428">y7feGBQe2k+jDmdpY6sh5Q==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <parent />
      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="1499022794">
        <changes />
        <obj dataType="ObjectRef">776100436</obj>
        <prefab dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
          <contentPath dataType="String">Data\Prefabs\Templates\GameCamera.Prefab.res</contentPath>
        </prefab>
      </prefabLink>
    </item>
    <item dataType="Struct" type="Duality.GameObject" id="2646306308">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4126229178">
        <_items dataType="Array" type="Duality.Component[]" id="4268765696" length="4">
          <item dataType="Struct" type="Khronos.GameStateManager" id="2242064364">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2646306308</gameobj>
          </item>
          <item dataType="Struct" type="Khronos.Character.PlayerSpawner" id="1929239182">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2646306308</gameobj>
          </item>
          <item dataType="Struct" type="Khronos.Powerups.PowerupLibrary" id="1225440424">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">2646306308</gameobj>
          </item>
        </_items>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1418537914" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="266782464">
            <item dataType="Type" id="1091424924" value="Khronos.GameStateManager" />
            <item dataType="Type" id="3712061974" value="Khronos.Character.PlayerSpawner" />
            <item dataType="Type" id="2479990024" value="Khronos.Powerups.PowerupLibrary" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="3051657678">
            <item dataType="ObjectRef">2242064364</item>
            <item dataType="ObjectRef">1929239182</item>
            <item dataType="ObjectRef">1225440424</item>
          </values>
        </body>
      </compMap>
      <compTransform />
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="3930284444">nG/q4MI2vUqRzw4SnjGeww==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
